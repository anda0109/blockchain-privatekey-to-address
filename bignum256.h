...
#define BIGNUM256_HEX_STRING_LEN 64

extern int bigFromHexString(const char *str, BigNum256 out);
extern void bigToHexString(const BigNum256 in, char str[BIGNUM256_HEX_STRING_LEN + 3]);
